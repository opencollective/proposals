...
import { linkifyNostr, getTag, getFromLocalStorage, setupDateFormatting } from "./utils.js";
...
export const displayComment = (event, container) => {
  ...
  const commentEl = `
    <div class="flex gap-lg" data-comment-id="${id}" data-pubkey="${pubkey}">
      <a href="/${npub}">
  ...
  const comments = [...container.children].sort((a, b) => 
